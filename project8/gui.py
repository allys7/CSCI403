...
class Application:
    def __init__(self, window, db):
        ...
        self.search_cb = Combobox(
            self.search_frame, values=(
...
###################
    ...
    def get_artists(self):
        ...
        try:
            ...
            # extract string from each nested list
            result = []
    ...
    def insert_album(self, artist_name, album_name, year):
        ...
        try:
            self.cursor.execute(subquery, (artist_name, ))
            resultset = self.cursor.fetchall()
            artist_id = resultset[0][0]
